...
class MZI(Multilayer):
    ...
    def __post_init__(self):
        ...
        pattern_to_layer = sum([[(p, self.ridge)] if isinstance(p, Pattern) else p.pattern_to_layer for p in patterns],
                               [])
        ...
        self.top_input = self.top_input if self.top_external else None
        self.bottom_input = self.bottom_input if self.bottom_external else None
        self.port = port
