...
### testing to see if this actually does anything, will delete second time around
    ### changing dc_rib to dc_rib1
### rebecca 5/10/20
    def dc_rib1(self, gap_w: float, interaction_l: float, interport_w: float, end_l: float, radius: float,
               waveguide: float):
        with nd.Cell(name='dc_rib1') as dc_rib1:
